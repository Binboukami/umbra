...
void U_InitRenderer(URenderer *renderer, ui8 use_ebo) {
	...
	// Attrib 2: { s, t }
	U_SetVertexAttribute(U_DEFAULT_VERTEX_ATTR_TEXTURE_COORD_IDX, 2, GL_FLOAT, GL_FALSE, sizeof(UVertex),
	                     (sizeof(UVec3) * 2));

	// Attrib 3: { idx }
	U_SetVertexAttribute(U_DEFAULT_VERTEX_ATTR_TEXTURE_IDX, 1, GL_INT, GL_FALSE, sizeof(UVertex),
	                     (sizeof(UVec3) * 2) + (sizeof(UVec2)));
